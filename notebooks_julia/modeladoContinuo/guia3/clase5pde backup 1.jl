...
# ╔═╡ 3b136a54-5eaf-11ed-293f-09e20bc389ed
begin
	using Plots, LinearAlgebra, SparseArrays, DifferentialEquations
end

# ╔═╡ 403b2e21-aee0-46a4-a948-46db1fe5f77c
md""" ## Modelado Continuo 🦉🎸"""

# ╔═╡ 2efc6a25-ea97-43b6-8002-34e28660e2d8
md""" ## Ejercicio 10"""

# ╔═╡ a1ec6fc1-5f5b-4814-b8db-645ebc7a7c18
...
# ╔═╡ 7c2d554a-bbb1-4f9e-bd93-685d63d45558
u₀(x, y, t) = 4*(t^2 - 1)*(sin(2π*x) + sin(2π*y))

# ╔═╡ 4baeecb3-928c-48b6-8ee7-cca8d070c10a
begin
	xExtendido, yExtendido, sol = calor2d(-1.0, 1.0, -1.0, 1.0, 0.0, 0.8, u₀, 0.05, 0.05, 0.002, 0.2) #fuente 0 f(x, y, t)  
	plot(xExtendido, yExtendido, sol[:, 1])
end

# ╔═╡ 9eb3f625-a9d9-411a-9600-cc2c158da17c
anim = @animate for i in 1:size(sol)[2]
	plot(xExtendido, yExtendido, sol[:, i], zlim = (-7, 7))
end

# ╔═╡ da39dbc0-170f-4a73-9b1a-991365a3860d
gif(anim, "aaaaaa.gif", fps = 3)

# ╔═╡ 492763f1-b2cd-4c74-b092-788d68f9590f
size(sol)

# ╔═╡ f1a72d13-0c12-4035-b728-265213a6f8a7
typeof(1:0.05:1)

# ╔═╡ aaded05d-bc44-4e32-8619-17e2ab618804
md"""## Ejercicio 11"""

# ╔═╡ 1ef12b0c-fdac-45bf-8107-77a11396bd3d
