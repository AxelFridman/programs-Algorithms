...
TEST(string_map_test, copiarVacio) {
    string_map<int> nada;
    string_map<int> copia(nada);
    EXPECT_TRUE(copia.count("hola") == 0);
    EXPECT_TRUE(copia.count("chau") == 0);
    EXPECT_TRUE(copia.count("adios") == 0);
...
TEST(string_map_test, copiar) {
    ...
    sin_prefijos.insert(make_pair("chau", 2));
    sin_prefijos.insert(make_pair("adios", 3));
    sin_prefijos.insert(make_pair("p", 45));
