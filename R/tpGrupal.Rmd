...
```
```{r}
plot(dfFiltrados$AGE,dfFiltrados$FOOT.LENGTH,  xlab = "Edad en anios", ylab = "FOOT.LENGTH  en cm", col= dfFiltrados$SEX, main="FOOT.LENGTH en funcion de edad toda la poblacion")
