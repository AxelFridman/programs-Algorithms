...
dias = table(diaIng) #Poner diaIng o diaEsp segun corresponda
prop.table(table(dia))
barplot(dias, las=2, cex.names=0.65)
meses = table(mesIng) #Poner mesIng o mesEsp segun corresponda
prop.table(table(mes))
